...
router.post("/directory", verifyToken, allowRoles("admin"), ctrl.createDirectoryContact);
router.put("/directory/:id", verifyToken, allowRoles("admin"), ctrl.updateDirectoryContact);
